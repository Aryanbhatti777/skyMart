        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_380px]">
          <section className="space-y-3">
            ...
            <div className="flex justify-end pt-2">
              <button
                onClick={clearCart}
                className="flex items-center gap-2 text-xs font-medium text-zinc-600 transition hover:text-red-400"
              >
                <Trash2 size={14} />
                Clear Cart
              </button>
          ...
          <aside className="h-fit rounded-2xl border border-zinc-800 bg-[#101010] p-6 lg:sticky lg:top-6">
            ...
            <button
              ...
              className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-violet-600 font-semibold text-white transition hover:bg-violet-500 hover:shadow-lg hover:shadow-violet-600/20"
            >
              <ShoppingBag size={18} />
              Proceed to Checkout
            </button>
