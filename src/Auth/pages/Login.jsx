        ...
        <div className="relative z-10 flex flex-col justify-between w-full">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-white/60 text-lg mt-6 max-w-md leading-relaxed">
              Discover products you love, enjoy effortless shopping,
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-[430px]">
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ...
            <span onClick={()=> navigate("/register")} className="text-violet-400 font-semibold cursor-pointer hover:text-violet-300">
              Create account
            </span>
          </p>
